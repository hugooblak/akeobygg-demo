<?php
/**
 * Demo site setup for AKEO Bygg AB.
 *
 ...
 * Site settings
 * ----------------------------------------------------------------------- */
update_option( 'blogname', 'AKEO Bygg AB' );
...
$home = nps_page(
	...
	nps_pattern( 'akeobygg/page-home' ),
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'akeobygg/page-replacement' ),
...
nps_page(
	...
	nps_pattern( 'akeobygg/page-storm' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'akeobygg/quote-funnel' ),
...
$thanks = nps_page(
	'tack',
	'Tack',
	nps_pattern( 'akeobygg/thank-you' ),
...
<p class="has-large-font-size">AKEO Bygg AB är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om AKEO Bygg AB', $about_content . "\n\n" . nps_pattern( 'akeobygg/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'akeobygg/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
<!-- /wp:paragraph -->
HTML;
$privacy = nps_page( 'integritetspolicy', 'Integritetspolicy', $privacy_content, 'Så använder AKEO Bygg AB uppgifterna du skickar med offertformuläret.' );
...
nps_log( 'AKEO Bygg AB demo ready.' );
