...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'akeobygg-leads' ),
				'storm'       => __( 'Storm or hail damage', 'akeobygg-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'akeobygg-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'akeobygg-leads' ),
				'not-sure'    => __( 'Vet inte än', 'akeobygg-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'akeobygg-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'akeobygg-leads' ),
				'research' => __( 'Jag kollar bara priser', 'akeobygg-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'akeobygg-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'akeobygg-leads' ),
		'contacted' => __( 'Kontaktad', 'akeobygg-leads' ),
		'quoted'    => __( 'Quote sent', 'akeobygg-leads' ),
		'won'       => __( 'Won', 'akeobygg-leads' ),
		'lost'      => __( 'Lost', 'akeobygg-leads' ),
		'spam'      => __( 'Misstänkt spam', 'akeobygg-leads' ),
	);
}
